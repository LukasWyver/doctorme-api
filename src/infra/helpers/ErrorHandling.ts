...
import { BussinesError, NotFoundError, UnauthorizedError } from '@/infra/helpers/Errors'
...
export const errorHandling = (
    ...
    if(error instanceof BussinesError) statusCode = HttpStatusCode.UNPROCESSABLE_ENTITY
